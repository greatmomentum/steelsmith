        ...
        <div className={`flex-grow text-white ${isCollapsed ? 'hidden' : 'block'}`}>
          <div className='p-3'>
            ...
            <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
              ...
              <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'/'}>Dashboard</NavLink></div>
            ...
            <div className='my-1'>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./ProductCategories'}>Product Categories</NavLink></div>
              </div>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Products'}>Products</NavLink></div>
              </div>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Models'}>Models</NavLink></div>
              </div>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Catalogues'}>Catalogues</NavLink></div>
              </div>
            ...
            <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
              ...
              <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./DealerNetwork'}>Dealer Network</NavLink></div>
            </div>
            ...
            <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
              ...
              <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Markets'}>Markets</NavLink></div>
            </div>
            ...
            <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
              ...
              <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./News'}>News</NavLink></div>
            </div>
            ...
            <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
              ...
              <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Events'}>Events</NavLink></div>
            </div>
            ...
            <div className='my-4 border-t [1px] border-[#3f4b5d] py-4'>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./RegisteredUsers'}>Registered Users</NavLink></div>
              </div>
              ...
              <div className='bg-[#374252] hover:bg-[#3f4b5d] active:bg-[#3f4b5d]  active:ring-1 active:ring-[#326fa8] hover:ring-blue-400 outline-offset-1 m-1 rounded px-4 flex items-center divide-x-[1px] divide-[#3c4c64]'>
                ...
                <div className='text-sm tracking-wide font-normal p-2'><NavLink to={'./Login'}>Logout</NavLink></div>
              </div>
