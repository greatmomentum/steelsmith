        ...
        <div className="flex-auto inline-flex">
          ...
          <div className="flex-auto inline-flex justify-start items-center mr-1 bg-white pl-4 px-1 ">
            ...
            <div className='p-2 mx-1 text-base no-underline  text-[#003D6A] hover:bg-[#003D6A] hover:text-white hover:no-underline rounded '> <MegaMenu.Dropdown toggle={<>Products</>}>
              <div className="hidden w-full overflow-hidden  rounded-lg lg:block bg-gray-100 ">
                ...
                <div className="mx-auto flex items-center p-8">
                  ...
                  <div>
                    <div className="grid grid-cols-4 gap-2">
                      ...
                      <a href="/products" className="group border p-4 bg-white rounded">
                      ...
                      <a href="#" className="group gap-4 border p-4 bg-white rounded">
                        <div className="">
                    ...
                    <div className='flex justify-center'>
                      <a className=' text-white p-2 mt-4 no-underline' href='/allproducts'>
                        <div className='flex bg-[#003D6A] rounded hover:bg-gray-900 p-2'>
