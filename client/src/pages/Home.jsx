    ...
    <div className=''>
              ...
              <div className='flex-auto  w-1/2 h-full'>
                <div className='h-full grid grid-row-3 '>
                  <div className='h-10% flex items-center '>
                    {/* logo */}
                    <div>
                      <span><img className="w-[220px]" src={steelsmithlogo} alt="content" /></span>
                    </div>
                  </div>
              ...
              <div className='flex-auto  w-1/2 h-full'>
                <div className='h-full grid grid-row-3 '>
                  <div className='h-10% flex items-center '>
                    {/* logo */}
                    <div>
                      <span><img className="w-[220px]" src={imaologo} alt="content" /></span>
                    </div>
                  </div>
                  <div className='items-stretch space-y-1 px-4'>
                    {/* 1 */}
              ...
              <div className='flex-auto  w-1/2 h-full'>
                <div className='h-full grid grid-row-3 '>
                  <div className='h-10% flex items-center '>
                    {/* logo */}
                    <div>
                      <span><img className="w-[220px]" src={kipplogo} alt="content" /></span>
                    </div>
                  </div>
                  <div className='items-stretch space-y-1 px-4'>
                    {/* 1 */}
              ...
              <div className='flex-auto  w-1/2 h-full'>
                <div className='h-full grid grid-row-3 '>
                  <div className='h-10% flex items-center '>
                    {/* logo */}
                    <div>
                      <span><img className="w-[220px]" src={turnlocklogo} alt="content" /></span>
                    </div>
                  </div>
                  <div className='items-stretch space-y-1 px-4'>
                    {/* 1 */}
      ...
      <section className="text-slate-800 body-font pb-12">
        <div className="text-center mb-6">
          <p className="text-center text-xl text-gray-800 pt-12 m-2"><b>Featured Products</b></p>
          ...
          <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="py-8 flex flex-wrap ">
              <div className="p-2 w-1/3 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                ...
                <div className=" w-full my-4 lg:mb-0">
                  <p className="text-xl font-normal mb-2 text-slate-800">
