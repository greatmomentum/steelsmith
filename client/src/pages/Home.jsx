        ...
        <div className="container px-5 py-12  w-[1300px] mx-auto">
          <div className="flex flex-wrap w-full my-10">
            <div className="lg:w-1/3 w-full my-4 lg:mb-0">
              ...
              <div className="h-0.5 w-14 bg-[#003D6A] rounded" />
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="xl:w-1/5 md:w-1/2 p-1 ">
              <div className="bg-white p-6 rounded-lg h-[320px]">
                <img
                  className="rounded w-full object-center mb-6"
                  src="./src/images/brand-1b.jpg"
                  alt="content"
                />
                {/* <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Steel-Smith</h2> */}
                <div className="rounded flex">
                  <svg
                    ...
                    strokeWidth={3}
                    className="mt-1 text-[#003D6A]-500 w-3 h-3  mr-2"
                    viewBox="0 0 24 24"
                  >
                    <path d="M22 11.08V12a10 10 0 11-5.93-9.14" />
                    <path d="M22 4L12 14.01l-3-3" />
                  </svg>
                  <span className="text-sm">Toggle Clamps</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Latches</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Roto-Moulding Clamps</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Leveling Pads</span>
                </div>
                <div className="mt-12 w-full justify-between items-center inline-flex ">
                  <a className="text-blue-800 items-center md:mb-2 lg:mb-0">
                    View Products</a>
                  <svg
            ...
            <div className="xl:w-1/5 md:w-1/2 p-1">
              <div className="bg-white p-6 rounded-lg">
                <img
                  className="rounded w-full object-center mb-6"
                  src="./src/images/brand-2a.jpg"
                  alt="content"
                />
                {/* <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Kipp</h2> */}
                <div className="rounded flex">
                  <svg
                    fill="none"
                    stroke="currentColor"
                  ...
                  <span className="text-sm">One Touch Fasteners</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">One Touch Clamps</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">OD &amp; ID Holding Clamps</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Flex Locators</span>
                </div>
                <div className="mt-12 w-full justify-between items-center inline-flex ">
                  <a className="text-blue-800 items-center md:mb-2 lg:mb-0">
                    View Products</a>
            ...
            <div className="xl:w-1/5 md:w-1/2 p-1">
              <div className="bg-white p-6 rounded-lg">
                <img
                  className="rounded w-full object-center mb-6"
                  src="./src/images/brand-3a.jpg"
                  alt="content"
                />
                {/* <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Imao</h2> */}
                <div className="rounded flex">
                  <svg
                    fill="none"
                    stroke="currentColor"
                  ...
                  <span className="text-sm">Spring Plungers</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Indexing Plungers</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Grips and Knobs</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Quater-Turn Locks</span>
                </div>
                <div className="mt-12 w-full justify-between items-center inline-flex ">
                  <a className="text-blue-800 items-center md:mb-2 lg:mb-0">
                    View Products</a>
            ...
            <div className="xl:w-1/5 md:w-1/2 p-1">
              <div className="bg-white p-6 rounded-lg">
                ...
                <div className="rounded flex">
                  ...
                  <span className="text-sm">Light Duty Fasteners</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Medium Duty Fasteners</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
                  ...
                  <span className="text-sm">Heavy Duty Fasteners</span>
                </div>
                <div className="rounded flex">
                  <svg
                    fill="none"
          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-1">
              <div className="border border-gray-200 p-6 rounded-lg ">
                <div className="w-24 h-24 items-center rounded-full bg-indigo-100 text-indigo-500 mb-4 ">
                  <img
          ...
          <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="py-8 flex flex-wrap ">
              <div className="p-2 w-1/3 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                <div className="rounded flex pl-24">
