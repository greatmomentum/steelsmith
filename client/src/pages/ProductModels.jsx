    ...
    <div className='container pt-10'>
      ...
      <div className='space-y-10 mb-20'>
        ...
        <div className='border-4 border-slate-300 '>
          <div className='mx-auto justify-center mt-1'><span className='bg-slate-300 text-white p-2'>Product Group 1</span></div>
          ...
          <div className='flex justify-center border-b-2 my-2 space-x-1'>
            <div className='items-center'>
              <button>
                <div className='flex p-3 mt-2 bg-[#003D6A] text-white'>
                  <span className='pr-2'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        {/* GROUP 2 start */}
        <div className='border-4 border-slate-300'>
          <div className='mx-auto justify-center mt-1'><span className='bg-slate-300 text-white p-2'>Product Group 2</span></div>
