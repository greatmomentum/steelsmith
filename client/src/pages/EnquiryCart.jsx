            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-8">
                        ...
                        {/* product 1 start*/}
                        <div className="card border shadow-none hover:bg-slate-50 my-4">
                            <div className="card-body relative">
                                <div className="d-flex align-items-start  pb-3 ">
                                    ...
                                    <div className="flex-grow-1 align-self-center overflow-hidden ">
                                        ...
                                        <div className='grid grid-col-4 py-1 '>
                                            <div><p className="mb-0 mt-1 p-2">Quantity :</p></div>
                                            <div className='w-[100px] '><select className="form-select form-select-sm w-xl">
                                            ...
                                            <div className='absolute top-0 right-0 p-2'><a href="#">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#424242" className=" p-2 w-10 h-10">
                        ...
                        <div className="row my-4 ">
                            <div className="col-sm-6">
                                <a href="ecommerce-products.html" className="btn btn-link text-muted">
                                    <i className="mdi mdi-arrow-left me-1" /> Continue to Products
                                </a>
                            </div>
                            {/* end col */}
                            ...
                            <div className="card border shadow-none">
                                ...
                                <div className="card-body p-4 pt-2">
                                    ...
                                    <form class="mx-auto py-4">
                                        ...
                                        <div className='mt-10'>
                                                <span href="/enquirycart" className=" no-underline px-12 py-3 text-base font-medium text-white bg-[#003D6A] hover:bg-black rounded-md">
                                                     Send Enquiry</span> 
